...
class Collection extends AbstractCollection
{
    ...
    protected function _afterLoad()
    {
        ...
        $this->performAfterLoad('shopfinder_shops_store', $entityMetadata->getLinkField());
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(ShopInterface::class);
        $this->joinStoreRelationTable('shopfinder_shops_store', $entityMetadata->getLinkField());
    }
}
